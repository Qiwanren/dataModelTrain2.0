...
def fileNumberFeature(data):
    nums_params = ['innet_months', 'cust_sex', 'cert_age', 'total_fee', 'jf_flux', 'fj_arpu', 'ct_voice_fee',
                   ...
                   'imei_duration', 'shejiao_active_days',
                   'shejiao_visit_cnt', 'xinwen_active_days', 'xinwen_visit_cnt', 'shipin_active_days',
                   'shipin_visit_cnt', 'dshipin_active_days', 'dshipin_visit_cnt',
                   'zhibo_active_days', 'zhibo_visit_cnt', 'waimai_active_days', 'ditudaohang_visit_cnt',
                   'luntan_active_days', 'luntan_visit_cnt', 'shouji_shoping_active_days',
                   'shouji_shoping_visit_cnt', 'liulanqi_active_days', 'liulanqi_visit_cnt', 'wenhua_active_days',
                   'wenhua_visit_cnt', 'youxi_active_days', 'youxi_visit_cnt',
...
def getModelResult(trainFilePath, testFilePath, labels):
    ...
    feature_params = ['area_id', 'innet_months', 'service_type', 'cust_sex', 'cert_age', 'total_fee', 'jf_flux',
                      'fj_arpu', 'ct_voice_fee', 'total_flux', 'total_dura', 'roam_dura',
                      'total_times', 'total_nums', 'local_nums', 'roam_nums', 'in_cnt', 'out_cnt', 'out_dura',
                      'heyue_flag', 'activity_type', 'is_limit_flag',
                      'product_type', '5g_flag', 'brand_flag', 'price', 'imei_duration', '5g_city_flag',
                      'shejiao_active_days', 'shejiao_visit_cnt', 'xinwen_active_days', 'xinwen_visit_cnt',
                      'shipin_active_days',
                      'shipin_visit_cnt', 'dshipin_active_days', 'dshipin_visit_cnt', 'zhibo_active_days',
                      'zhibo_visit_cnt', 'waimai_active_days', 'ditudaohang_visit_cnt', 'luntan_active_days',
